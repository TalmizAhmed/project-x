...
## Environments
- Preview: https://main--project-x--TalmizAhmed.hlx.page/
- Live: https://main--project-x--TalmizAhmed.hlx.live/
...
1. Open the `project-x` directory in your favorite IDE and start coding :)
